...
{
    public partial class CargoInFind : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string sql = "SELECT * " +
                "FROM CargoIn " +
                "WHERE ";
            if (TextBox1.Text.Trim() != string.Empty)//判断文本框内容是否为空
            {
            ...
            {
                Response.Write("<script language=javascript>alert('快点给我输入一点什么啊混蛋!');window.location = 'CargoInFind.aspx';</script>");
            }
